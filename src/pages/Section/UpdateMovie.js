...
import { getMovievById, updateMoviev, getLanguageOptions } from "../../api/movievApi";
...
const handleUpdateSubmit = async (e) => {
  ...
  if (!formData.release_year) newErrors.release_year = "Release year is required";
                ...
                <form onSubmit={handleUpdateSubmit}>
                  <Row>
                    ...
                    <Col md="6">
                      ...
                      />
                      {errors.release_year && (
                        <span className="text-danger">{errors.release_year}</span>
                      )}
                    </Col>
                    <Col md="6">
                    ...
                    <Col md="12" className="mt-4">
                      ...
                      <Button type="button" color="secondary" onClick={handleAddWatchLink}>
                        + Add Watch Link
                      </Button>
                    </Col>
                  </Row>
