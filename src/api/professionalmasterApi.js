...
export const getSectionTemplateOptions = async () => {
  const response = await fetch(
    `${BASE_URL}/api/professionalmaster/SectionTemplateOptions`,
    {
      method: "GET",
...
export const addprofessionalmaster = async (formData) => {
  const response = await fetch(
    `${BASE_URL}/api/professionalmaster/addprofessional`,
    {
      method: "POST",
      body: formData,
    }
...
export const updateprofessionalmaster = async (id, formData) => {
  const response = await fetch(
    `${BASE_URL}/api/professionalmaster/updateprofessional/${id}`,
    {
      method: "PATCH",
      body: formData,
    }
...
export const deleteprofessionalmaster = async (id) => {
  const response = await fetch(
    `${BASE_URL}/api/professionalmaster/deleteprofessional/${id}`,
    {
      method: "DELETE",
    }
  );
...
export const updateprofessionalmasterStatus = async (id, status) => {
  const response = await fetch(
    `${BASE_URL}/api/professionalmaster/update-statusprofessional`,
    {
      method: "PATCH",
      headers: { "Content-Type": "application/json" },
...
export const getprofessionalmasterById = async (id) => {
  const response = await fetch(
    `${BASE_URL}/api/professionalmaster/getprofessionalByid/${id}`
  );
